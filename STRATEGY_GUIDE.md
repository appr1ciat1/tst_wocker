...
### 已測試 — 宏觀 Regime (VIX) + Ensemble

| 配置 | Sharpe | MDD | Calmar | 結論 |
|------|:---:|:---:|:---:|:---:|
| **v8.5 Baseline** | **2.47** | **-14.2%** | **4.40** | ✅ 最佳 |
| MacroRegime (VIX) | 2.46 | -14.1% | 4.33 | MDD 微降但 Sharpe 微降 🔴 |
| Macro + Floor 0.20 | 2.44 | **-13.9%** | 4.39 | MDD 最低但 Calmar 略低 🔴 |
| Macro + Floor 0.00 | 2.30 | -14.9% | 3.83 | 完全停手太激進 🔴 |
| Ensemble (F0.10+F0.00) | 2.19 | -16.9% | 3.29 | 平均後反而劣化 🔴 |
| Ensemble (F0.10+MacroF0.20) | 2.25 | -16.4% | 3.52 | 同上 🔴 |

**結論**：VIX 宏觀疊加在 MDD 方面有微弱效果（-14.2%→-13.9%），但 Sharpe/Calmar 略降。Ensemble 雙策略因被差的那條腿拖累反而劣化。v8.5 Baseline 依然全面最優。

### 尚未探索的安全方向

1. **分批建倉**：同一檔分 3 天進場，降低單日 Gap 衝擊
2. **月營收動能**：需外部數據源
3. **台指期隱含波動率**：比 VIX 更在地化的恐慌指標
